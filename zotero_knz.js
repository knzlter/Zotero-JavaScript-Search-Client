...
var ZOTERO_CONFIG = {
   "zotId": "4618153", // ID of group or user library to search in Zotero, e.g., 2211939, 2055673
   "zotIdType": "group", // group or user
   "collectionKey": "", // Key of collection within library to search, e.g., "KHTHLKB5", or "" if no collection
   "filterTags": "AA95K7QM", // For filtering results by tag(s), e.g., "&tag=LTER-Funded".  See examples at https://www.zotero.org/support/dev/web_api/v3/basics
   ...
   "showTags": ["Foundational", "LTER-Funded", "KNZ-Assisted"], // Include a column showing this tag if present for each item
   ...
   "showPages": 11, // MUST BE ODD NUMBER! Max number of page links to show
